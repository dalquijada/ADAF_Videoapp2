...
document.addEventListener(
    ...
    function (event) {
         ...
         */
        var peer = new Peer({
            host: "adafvideoapp2.herokuapp.com",
            port: 443,
            secure: true,
            debug: 3,
            config: {
        ...
        peer.on("call", function (call) {
            var acceptsCall = confirm(
                "Video llamada entrante, desea aceptarla?"
            );
        ...
        function handleMessage(data) {
            ...
            var messageHTML =
                ...
                '">';
            messageHTML +=
                '<h4 class="list-group-item-heading" style ="color:rgb(110,20,110)">' +
                data.from +
                "</h4>";
            messageHTML +=
        ...
        document.getElementById("connect-to-peer-btn").addEventListener(
            ...
            function () {
                ...
                document.getElementById("connection-form").className +=
                    " hidden";
            },
            false
        );
